    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto pointer-events-auto">
      <form onSubmit={step === 1 ? sendOTP : verifyOTP} className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-lg border border-gray-100 my-8 pointer-events-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Employee Register</h2>
            <p className="text-xs text-gray-600 mt-1">{step === 1 ? 'Create your account' : 'Verify email'}</p>
          </div>
          <button
            onClick={onClose}
        ...
        {step === 1 ? (
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              <label className="block text-xs font-medium text-gray-700 mb-1">Employee Key</label>
              <input
                type="password"
            ...
            <button
              type="submit"
              disabled={otpLoading}
              className="col-span-2 mt-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm rounded-lg font-semibold hover:shadow-lg transition disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {otpLoading ? (
                <>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="000000"
                maxLength="6"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition text-center text-lg tracking-widest font-semibold"
                value={otp}
            ...
            <button
              ...
              className="w-full px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm rounded-lg font-semibold hover:shadow-lg transition disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                  <Spinner size="sm" className="text-white" />
